...
function [bdryFixed, bdryBasis] = octaBdryBasis(bdryNormals)
    ...
    bdryBasis = multiprod_legacy(multitransp(BdryRotStacked), sparse([1 9], [1 2], [1, 1], 9, 2));
    bdryFixed = multiprod_legacy(multitransp(BdryRotStacked), [0 0 0 0 sqrt(7/12) 0 0 0 0]', [1 2], 1);
end
